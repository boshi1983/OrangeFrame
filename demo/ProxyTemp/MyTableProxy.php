...
const VERSION = 1603074493.915;
public function getListByIn(array $ids):array{
$param0 = $this->foreach($ids,'id','#{id}','(',',',')');
$sql = ' select * from my_table where id in ' . $param0 . '  order by id';
